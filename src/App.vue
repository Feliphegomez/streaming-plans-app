...
export default {
  ...
  computed: {
    ...
    ...mapGetters({ 'StateUser': 'StateUser' }),
    ...mapGetters({ 'sessionState': 'sessionState' }),
  },
  components: {
  },
  created() {
    console.log('Create App', this.StateUser)
  },
  mounted() {
    // console.clear()
    this.checkedDarkMode()
  ...
  methods: {
    ...
    checkedDarkMode() {
        ...
        if (self.$root.settings.app.Dark_Mode.default) {
            pageBody.classList.add("dark-mode");
        }

        // Local Dark Mode
        if (self.$root.settings.app.Dark_Mode.local_mode.enable) {
            var nightStart = self.$root.settings.app.Dark_Mode.local_mode.start_time;
            var nightEnd = self.$root.settings.app.Dark_Mode.local_mode.end_time;
        ...
        if (self.$root.settings.app.Dark_Mode.auto_detect.enable)
